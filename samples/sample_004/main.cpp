...
int main(int argc, char *argv[]) {
  ...
  SpaceCharge::Particle<double> part("proton", 1, SpaceCharge::cst::mproton,
                                     SpaceCharge::cst::lfactor::beta, 0.05);
  ...
  for (auto i = 0; i < 8; i++) {
    ...
    std::unique_ptr<SpaceCharge::Bunch<double>> bunch(
        new SpaceCharge::GaussianBunch<double>(
            part, bunch_current, bunch_period, SpaceCharge::cst::dir::z));
    ...
    SpaceCharge::quadv<double> offset{SpaceCharge::cst::sol * t_step * i -
                                          (SpaceCharge::cst::sol * t_step * 4),
